...
export function CompanyPage() {
    ...
    return <PageFrame>
        <section className="page-hero page-hero--company"><div className="shell page-hero__inner"><Reveal><Eyebrow>LYFSpot / The ecosystem</Eyebrow><h1>Build products<br /><span>people can keep.</span></h1><p>LYFSpot is the studio behind YRecall—an independent product company focused on high-quality, consumer-first software for real life.</p></Reveal><Reveal className="company-emblem reveal-delay-1"><img width="500" height="500" loading="lazy" decoding="async" src={LYFSPOT_MARK} alt="LYFSpot logo" /><span>LYFSpot</span><small>Design excellence / Privacy / Seamless engineering</small></Reveal></div></section>
        ...
        <section className="section section--founder-story" id="founder"><div className="shell founder-story-grid"><Reveal className="founder-story-photo"><img width="1280" height="959" loading="lazy" decoding="async" src={SRAVAN_PHOTO} alt="Sravan Sai Vuppula in a green field" /><div className="founder-story-tag"><span>Founder’s note</span><strong>Why YRecall exists</strong></div></Reveal><Reveal className="founder-story-copy reveal-delay-1"><Eyebrow tone="lime">Sravan Sai Vuppula / Founder</Eyebrow><h2>“Simplicity is not a smaller ambition. It is a sharper one.”</h2><p>There is a particular kind of modern frustration: you remember that the answer exists, but not where you left it. It is a small problem that repeats until it shapes the whole texture of a day.</p><p>I started YRecall to make that feeling lighter. Not by adding another demanding dashboard, but by creating a dependable layer between the things we intend to do and the things we are able to return to.</p><p>LYFSpot is being built with a long view: products that are rigorous under the hood, approachable at the surface, and worthy of a lasting relationship with the people who use them.</p><a className="inline-link" href="https://buildwithsravan.dev" target="_blank" rel="noreferrer">Visit Sravan’s portfolio <img width="192" height="192" loading="lazy" decoding="async" src={BUILDWITHSRAVAN_MARK} alt="" /> <ArrowUpRight size={15} /></a></Reveal></div></section>
        <section className="section section--ecosystem"><div className="shell ecosystem-card"><div className="ecosystem-card__top"><div><Eyebrow tone="lime">The ecosystem</Eyebrow><h2>One flagship.<br /><span>More to come.</span></h2><div style={{ marginTop: '20px' }}><a className="inline-link" href="https://sailyfspot.blogspot.com" target="_blank" rel="noreferrer">Explore LYFSpot <ArrowUpRight size={15} /></a></div></div><img width="500" height="500" loading="lazy" decoding="async" src={LYFSPOT_MARK} alt="LYFSpot mark" /></div><div className="ecosystem-road"><div className="road-item road-item--live"><span>01</span><strong>YRecall</strong><small>Organize what matters</small><b>Live product</b></div><div className="road-line" /><div className="road-item"><span>02</span><strong>Next chapter</strong><small>Tools for a fuller life</small><b>In the making</b></div></div></div></section>
    </PageFrame>;
}
...
export function ConfirmEmailPage() {
    ...
    return <PageFrame className="page-frame--handoff"><section className="handoff-page"><div className="handoff-grid" /><div className="handoff-card"><SmartLink to="/" className="handoff-brand"><span><img width="1920" height="1920" loading="lazy" decoding="async" src={YRECALL_MARK} alt="" /></span><strong>YRecall</strong></SmartLink><div className="handoff-form handoff-form--confirmed"><div className="confirmed-orb"><Check size={35} /></div><Eyebrow tone="lime">Email confirmed</Eyebrow><h1>You’re all<br /><span>set.</span></h1><p>Your email is confirmed. Open the YRecall app to continue building a calmer way to keep what matters close.</p><a className="button button--primary" href="mailto:support@yrecall.app?subject=Open%20YRecall">Open the app <ArrowUpRight size={16} /></a><div className="handoff-note"><Sparkles size={14} /> Welcome to a better recall rhythm.</div></div><div className="handoff-footer"><span>YRecall by LYFSpot</span><SmartLink to="/legal/privacy">Privacy</SmartLink><SmartLink to="/support">Need help?</SmartLink></div></div></section></PageFrame>;
}
